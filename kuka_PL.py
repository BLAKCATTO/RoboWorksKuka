...
# Konfiguracja ruchu w formacie: 
# (nazwa_przegubu, wartość_początkowa, wartość_końcowa, start_kroku, koniec_kroku, funkcja_easing)
CONFIGURATION = [
    # Theta1 - Ruch głównego przegubu
...
if __name__ == "__main__":
    ...
    print("Wygenerowano animacje z "+str(TOTAL_STEPS)+" krokami w pliku kuka_animation.txt")